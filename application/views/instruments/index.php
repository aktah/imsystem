...
<div class="card shadow mb-4">
  ...
  <div class="d-flex align-items-start">
    ...
    <div class="d-flex align-items-right justify-content-end">
      <a href="<?php echo base_url(); ?>instruments/create" class="btn btn-primary ml-2"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line('add'); ?></a>
    </div>
      ...
      <table class="table table-bordered" id="instrumentsTable" width="100%" cellspacing="0">
        ...
        <?php foreach($instruments as $instrument) : ?>
          <tr>
            ...
            <td><i class="fas fa-eye<?php echo $instrument["ins_inactive"] ? '-slash' : '';?> text-xs"></i> <a href="<?php echo base_url();?>instruments/view/<?php echo $instrument["ins_id"];?>"><?php echo $instrument["ins_name_en"];?></a></td>
