        ...
        <div class="form-group row">
            <div class="col-lg-3">
              <div class="form-group text-center">
                <?php if ($this->input->post("token") == NULL) : ?>
                  <img id="uploadImage" class="mmn-dropzone img-fluid" src="<?php echo base_url();?>assets/images/NO_IMG_600x600.png" />
                <?php else: ?>
                  <img id="uploadImage" class="mmn-dropzone img-fluid" src="<?php echo base_url();?>assets/uploads<?php echo $this->user_model->getImageToken($this->input->post("token"))["image_path"]; ?>" />
                <?php endif;?>
                <!-- Progress Bar -->
